...
public class MyCoprocessor extends BaseRegionObserver {
    ...
    public void postPut(ObserverContext<RegionCoprocessorEnvironment> e, Put put, WALEdit edit, Durability durability) throws IOException {
        ...
        //获取当前操作的表
        String oldTable = PropertiesUtil.getProperties().getProperty("hbase.table.name");
        ...
        //获取region数
        int regions = Integer.valueOf(PropertiesUtil.getProperties().getProperty("hbase.regions"));
